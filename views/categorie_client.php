			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xl-6 col-lg-5">
						<form class="header-search-form" action="?core=produit&action=cher_nom" method="POST" >
							<input name="nom" type="text" placeholder="Search on divisima ....">
					...
					<div class="col-xl-4 col-lg-5">
						<div class="user-panel">
							...
							<?php
								...
								$pro = $DB->query1("SELECT * FROM notification ");
								//$idn = $DB->query("SELECT id FROM notification ");
...
<div class="up-item">
								...
								<a href="./views/supprimerNotif.php">Notification<div class="shopping-card">
									<i class="flaticon"></i>
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media" href="./views/supprimerNotif.php">
		...
		<nav class="main-navbar">
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="?core=produit&action=top">top_produit</a></li>
					<li><a href="#">***
						<span class="new">***</span>
					</a></li>
					<li><a href="#">***</a>
					...
					<div class="filter-widget">
						<h2 class="fw-title">Categories</h2>
						               <?php 
                                        ...
                                        ?>
						<ol>
						<li type="circle" ><a href="?core=categorie&action=pageMS&nom=<?php echo $ligne->getNom(); ?>" > <?php echo $ligne->getNom(); ?>  </a></a>	                                          
							
							<a  href="?core=categorie&action=favoriscategorie&nom=<?php echo $ligne->getNom(); ?>" class="wishlist-btn" id="like"> <i class="flaticon-heart"  src="color_red()" onclick="document.getElementById('id1').style.color = 'red'"></i> </a>	
							<hr  width="70%" align=left color="e8e8f3">
                            </li>					
						</ol>
						 <?php  } ?>
...
<form action="?core=categorie&action=chercheprix" method="POST">
                            ...
                            <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content"  data-min="10" data-max="99">
							...
							<div class="range-slider">
                                ...
                                <div class="price-input">
                                    ...
                                    <button type="submit" name="cherche"value="chercher" style="background: pink ">Valid</button>
                                </div>
                            </div>                    
                        </div>
					</div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								...
								<div class="pi-pic">
								    ...
								    <form name="like">
									<div class="pi-links">
										<a href="./views/addpanier.php?id=<?php echo $ligne->getId(); ?>" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>		
										<a href="#" class="wishlist-btn" id="like"><i class="flaticon-heart"  onclick="color_red()"></i></a>	
										<script>
											function color_red()
											{
												document.getElementById('like').style.backgroundColor="red";
